...
feedback_data_file_path = "fo/feedback.json"
...
def app():
    ...
    st.title("Felgenoutlet Ai - Support Tool")
...
def display_feedback(question, answer, tokens_used, model_parameters):
    with st.form(key="feedback_form", clear_on_submit=True):
        ...
        helpwise = st.text_input("Please provide your ticket Number or URL here:", key="helpwise")
